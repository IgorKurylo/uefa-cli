...
class UefaService {
    ...
    live() {
        return http_client_1.default.get(`scores/live.json?${constant_1.SECRETS}&competition_id=${constant_1.COMPTETITION_ID}&country=2`);
    }
}
exports.default = new UefaService();
